    ...
    return (
      <Sheet>
        <SheetTrigger asChild>
          <Button 
            variant="outline"
            className="w-full flex items-center justify-center gap-2 mb-2 md:mb-4"
          >
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow py-4 md:py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <header className={`mb-4 md:mb-8 transition-all duration-500 ${
            headerVisible ? 'animate-fade-in opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">Escort Directory</h1>
          ...
          {/* Search Bar */}
          <div className={`mb-4 md:mb-8 flex items-center bg-card rounded-lg shadow-sm p-2 max-w-2xl transition-all duration-500 ${
