...
const EscortCard = ({
  ...
  return <div className={`group relative bg-card rounded-lg overflow-hidden shadow-md card-hover transition-all duration-500 ${isVisible ? 'animate-fade-in opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      <Link to={`/profile/${escort.id}`}>
        <div className="aspect-[3/4] relative overflow-hidden">
          {!imageLoaded && <Skeleton className="w-full h-full absolute inset-0" />}
          <img src={escort.profile_picture || "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"} alt={escort.display_name || escort.username} className={`w-full h-full object-cover transition-all duration-500 group-hover:scale-105 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`} onLoad={() => setImageLoaded(true)} loading="lazy" />
        ...
        <div className="p-4">
          ...
          <div className="flex items-center mt-1 text-sm text-muted-foreground">
            ...
            {escort.verified && <Badge variant="outline" className="ml-2 flex items-center border-green-500 text-green-400 text-xs">
          ...
          <div className="mt-2 flex flex-wrap gap-1">
            {escort.ethnicity && <Badge variant="secondary" className="bg-muted text-muted-foreground text-xs">
                {escort.ethnicity}
              </Badge>}
            {escort.body_type && <Badge variant="secondary" className="bg-muted text-muted-foreground text-xs">
                {escort.body_type}
              </Badge>}
          </div>
...
const FilterSidebar = ({
  ...
  const FilterContent = () => <div ref={scrollContainerRef} className={`bg-card rounded-lg shadow-md p-4 sticky top-20 transition-all duration-500 max-h-[80vh] overflow-y-auto ${isVisible ? 'animate-fade-in opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
      ...
      <div className="mb-6">
        ...
        <LocationSelector value={filters.location || ''} onValueChange={value => handleFilterChange({
        ...filters,
        location: value
      ...
      <div className="mb-6">
        ...
        <Select value={filters.gender || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
      ...
      <div className="mb-6">
        ...
        <Select value={filters.ethnicity || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
      ...
      <div className="mb-6">
        ...
        <Select value={filters.nationality || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
      ...
      <div className="mb-6">
        ...
        <Select value={filters.body_type || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        body_type: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <Select value={filters.hair_color || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        hair_color: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <Select value={filters.eye_color || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        eye_color: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <Select value={filters.cup_size || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        cup_size: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <Select value={filters.smoking || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        smoking: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <Select value={filters.drinking || 'all'} onValueChange={value => handleFilterChange({
        ...filters,
        drinking: value === 'all' ? '' : value
      })}>
          <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Select value={filters.ageMin?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          ageMin: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
            ...
            <SelectContent>
              ...
              {Array.from({
              length: 43
            }, (_, i) => i + 18).map(age => <SelectItem key={age} value={age.toString()}>{age}</SelectItem>)}
            </SelectContent>
          </Select>
          <Select value={filters.ageMax?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          ageMax: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Select value={filters.heightMin?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          heightMin: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
              <SelectValue placeholder="Min" />
            </SelectTrigger>
            <SelectContent>
              ...
              {Array.from({
              length: 13
            }, (_, i) => i * 5 + 140).map(height => <SelectItem key={height} value={height.toString()}>{height}cm</SelectItem>)}
            </SelectContent>
          </Select>
          <Select value={filters.heightMax?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          heightMax: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
              <SelectValue placeholder="Max" />
            </SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Select value={filters.weightMin?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          weightMin: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
              <SelectValue placeholder="Min" />
            </SelectTrigger>
            <SelectContent>
              ...
              {Array.from({
              length: 18
            }, (_, i) => i * 5 + 35).map(weight => <SelectItem key={weight} value={weight.toString()}>{weight}kg</SelectItem>)}
            </SelectContent>
          </Select>
          <Select value={filters.weightMax?.toString() || 'all'} onValueChange={value => handleFilterChange({
          ...filters,
          weightMax: value === 'all' ? null : parseInt(value)
        })}>
            <SelectTrigger>
              <SelectValue placeholder="Max" />
            </SelectTrigger>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          {['Dinner Date', 'Travel Companion', 'Event Escort', 'Overnight', 'GFE', 'PSE', 'Massage'].map(service => <div key={service} className="flex items-center">
              <Checkbox id={`service-${service}`} checked={filters.services?.includes(service)} onCheckedChange={checked => {
            const services = filters.services || [];
            const newServices = checked === true ? [...services, service] : services.filter((s: string) => s !== service);
            handleFilterChange({
              ...filters,
              services: newServices
            });
          }} />
              <label htmlFor={`service-${service}`} className="ml-2 text-sm text-foreground">
                {service}
              </label>
            </div>)}
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            <Checkbox id="verified" checked={filters.verifiedOnly} onCheckedChange={checked => handleFilterChange({
            ...filters,
          ...
          <div className="flex items-center">
            <Checkbox id="featured" checked={filters.featuredOnly} onCheckedChange={checked => handleFilterChange({
            ...filters,
      ...
      <Button className="w-full btn-gold" onClick={() => handleFilterChange({
      location: '',
      gender: '',
      ethnicity: '',
      nationality: '',
  ...
  if (isMobile) {
    return <Sheet>
        <SheetTrigger asChild>
          <Button variant="outline" className="w-full flex items-center justify-center gap-2 mb-2 md:mb-4">
...
const Directory = () => {
  ...
  const fetchEscorts = async () => {
    try {
      ...
      const {
        data,
        error
      } = await supabase.from('profiles').select('*').in('role', ['escort', 'agency']).eq('status', 'approved').eq('is_active', true).order('featured', {
        ascending: false
      }).order('created_at', {
        ascending: false
      });
  ...
  const filteredEscorts = escorts.filter(escort => {
    ...
    if (filters.services && filters.services.length > 0) {
      ...
      const hasService = filters.services.some((service: string) => escortServices.includes(service.toLowerCase()));
      if (!hasService) {
        return false;
      }
    }
    if (filters.searchQuery) {
      ...
      return escort.display_name?.toLowerCase().includes(query) || escort.username?.toLowerCase().includes(query) || escort.location?.toLowerCase().includes(query) || escort.services?.toLowerCase().includes(query) || escort.ethnicity?.toLowerCase().includes(query) || escort.body_type?.toLowerCase().includes(query) || escort.nationality?.toLowerCase().includes(query);
    }
    return true;
  });
  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow py-4 md:py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <header className={`mb-4 md:mb-8 transition-all duration-500 ${headerVisible ? 'animate-fade-in opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          {/* Search Bar */}
          <div className={`mb-4 md:mb-8 flex items-center bg-card rounded-lg shadow-sm p-2 max-w-2xl transition-all duration-500 ${searchVisible ? 'animate-fade-in opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <Search className="h-5 w-5 text-muted-foreground mx-2" />
            <Input type="text" placeholder="Search by name, location, ethnicity, service, or nationality..." className="flex-1 border-0 focus-visible:ring-0 focus-visible:ring-transparent bg-card text-foreground" value={filters.searchQuery} onChange={e => setFilters({
            ...filters,
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <div className="flex-1">
              ...
              {currentEscorts.length > 0 ? <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {currentEscorts.map((escort, index) => <EscortCard key={escort.id} escort={escort} index={index} />)}
                </div> : <div className="bg-card rounded-lg p-8 text-center animate-fade-in">
